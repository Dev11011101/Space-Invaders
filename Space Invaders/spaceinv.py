...
class SpaceInvaders:
    ...
    def setup_credits(self):
        ...
        title_pos[1] = self.add_text_row(self.screen_credits, self.font_highscorelist, 'TONY STARK', title_pos[1], None, 3.0)
        title_pos[1] = self.add_text_row(self.screen_credits, self.font_highscorelist, 'PROGRAMMER', title_pos[1], None, 1.5)
        title_pos[1] = self.add_text_row(self.screen_credits, self.font_highscorelist, 'EDWIN JARVIS', title_pos[1], None, 3.0)
